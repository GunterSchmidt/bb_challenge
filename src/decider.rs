...
pub fn run_decider_generator_single_thread_reporting(
    ...
    loop {
        ...
        duration_generator += start_batch.elapsed();
        let start_batch = Instant::now();
        ...
        result.add_result(&r);
        duration_decider += start_batch.elapsed();
...
pub fn run_decider_generator_threaded<D, G>(
    decider: D,
    generator: G,
...
{
    run_decider_generator_threaded_reporting(
        decider,
        generator,
