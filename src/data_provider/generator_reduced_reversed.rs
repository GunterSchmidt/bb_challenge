...
pub struct GeneratorReducedReversed {
...
impl Generator for GeneratorReducedReversed {
...
impl DataProvider for GeneratorReducedReversed {
    fn name(&self) -> &str {
        "Generator Reduced"
    }
...
impl DataProviderThreaded for GeneratorReducedReversed {
...
mod tests {
    ...
    fn generator_reduced_direct_access_batch_no() {
        ...
        let mut batch_no = 0;
        let mut generator_reduced = GeneratorReducedReversed::new(&config);
        loop {
        ...
        let mut g = GeneratorReducedReversed::new(&config);
    ...
    fn compare_generator_reduced_with_full_for_bb3() {
        ...
        let mut generator = GeneratorReducedReversed::new(&config);
    ...
    fn run_test_decider_generator_reduced(n_states: usize) {
        ...
        let generator = GeneratorReducedReversed::new(&config);
