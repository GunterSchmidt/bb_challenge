...
use crate::{
    ...
    tape::{tape_compact::TapeCompact, tape_utils::TAPE_SIZE_BIT_U128, Tape},
...
impl Display for DeciderDataCompact {
...
#[cfg(feature = "bb_enable_html_reports")]
impl From<&DeciderDataCompact> for crate::html::StepHtml {
    fn from(data: &DeciderDataCompact) -> Self {
