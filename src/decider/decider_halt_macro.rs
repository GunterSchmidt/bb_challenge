...
use crate::{
    ...
    decider::{
        ...
        Decider, DECIDER_HALT_MACRO_ID,
    },
    machine_binary::{MachineId, NotableMachineBinary},
    status::MachineStatus,
};

pub struct DeciderHaltMacro {
    data: DeciderDataMacro,
}

impl DeciderHaltMacro {
...
impl Decider for DeciderHaltMacro {
    fn decider_id() -> &'static decider::DeciderId {
        &DECIDER_HALT_MACRO_ID
    }
...
impl Display for DeciderHaltMacro {
...
// pub fn test_decider_halt_u128_applies_bb4_max() {
...
pub fn test_decider_halt(tm_text_format: &str) {
    ...
    let config = Config::builder(machine.n_states())
        ...
        .build();
    let check_result = DeciderHaltMacro::decide_single_machine(&machine, &config);
    println!("{}", check_result);
...
mod tests {
    ...
    #[test]
    fn decider_halt_u128_applies_bb4_max() {
