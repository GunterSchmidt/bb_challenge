...
use crate::{
    ...
    decider::{Decider, ThreadResultDataProvider, ThreadResultDecider},
    decider_result::{DeciderResultStats, DurationDataProvider, EndReason, ResultBatchInfo},
    generator::Generator,
    machine::Machine,
    ...
    G: Generator + Send + 'static,
{
    ...
    result.name = format!("BB{}: ", n_states) + decider.name() + " threaded";
