...
//! This works fine, but is 25% slower than tape_long_shifted (possibly due to more loads/saves to tape_long).
...
impl Tape for TapeLongFixedApex {
...
impl Default for TapeLongFixedApex {
    fn default() -> Self {
        Self {
            tape_short: 0,
            head: POS_HALF_U128,
...
impl std::fmt::Display for TapeLongFixedApex {
